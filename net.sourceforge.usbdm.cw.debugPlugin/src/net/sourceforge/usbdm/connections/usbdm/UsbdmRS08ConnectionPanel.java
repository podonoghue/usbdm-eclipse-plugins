...
public class UsbdmRS08ConnectionPanel extends UsbdmConnectionPanel {
    ...
    * @param style
    */
   public UsbdmRS08ConnectionPanel(Composite parent, int style) {
      super(parent, style);
      init();
   }
...
//      System.err.println("UsbdmRS08ConnectionPanel.loadSettings()");
      super.loadSettings(iLaunchConfiguration);
      loadRS08Settings(iLaunchConfiguration);
      transferToWindow();
   }
    ...
    *           - Settings object to load from
    */
   public void loadRS08Settings(ILaunchConfiguration iLaunchConfiguration) {
