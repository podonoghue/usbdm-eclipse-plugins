...
public class UsbdmCS_Coldfire_BuiltinSpecsDetector extends GCCBuiltinSpecsDetector implements
    ...
    */
   static final String toolchainId = "net.sourceforge.usbdm.cdt.coldfire.toolchain";
//   static final String toolchainId = "net.sourceforge.usbdm.cdt.holder";
   @Override
   public String getToolchainId() {
      System.err.println("UsbdmCS_Coldfire_BuiltinSpecsDetector.getToolchainId() => id = \'" + toolchainId + "\'");
      return toolchainId;
//      return super.getToolchainId();
   ...
   protected String resolveCommand(String languageId) throws CoreException {
      ...
      System.err.println("UsbdmCS_Coldfire_BuiltinSpecsDetector.resolveCommand() => (B)commandLine = \'" + commandLine + "\'");
      try {
...
//            System.err.println("UsbdmCS_Coldfire_BuiltinSpecsDetector.resolveCommand() => ${"+UsbdmConstants.CODESOURCERY_ARM_PATH_KEY+"} = \'" + codesourceryPath + "\'");
...
//            String codesourceryPath = variable.getValue();
//            codesourceryPath = codesourceryPath.replace('\\', '/');
//            System.err.println("UsbdmCS_Coldfire_BuiltinSpecsDetector.resolveCommand() => ${"+UsbdmConstants.CODESOURCERY_COLDFIRE_PATH_KEY+"} = \'" + codesourceryPath + "\'");
...
//         }
      ...
      System.err.println("UsbdmCS_Coldfire_BuiltinSpecsDetector.resolveCommand() => (A)commandLine = \'" + commandLine + "\'");
      return commandLine;
   }
