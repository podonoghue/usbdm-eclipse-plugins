   ...
   static String writeRegions(final ArrayList<MemoryRange> memoryRanges, String pCapName, String pName, String attributes) {
      ...
      for(MemoryRange region:memoryRanges) {
         ...
         if (pCapName.equals("FLASH")) {
            memoryMap.append(String.format(MEM_FORMAT_FLASH, currentName, "("+attributes+")", region.start, region.end-region.start+1));
            memoryMap.append(String.format(MEM_FORMAT_BOOT,  "bootInfo",  "("+attributes+")", region.end+1));
         }
         else {
