...
public class UsbdmConfigurationPage extends WizardPage implements IWizardDataPage {

   private String                      gccCommand = "";
   private IWizardPage                 nextPage  = null;
   private UsbdmProjectTypeSelection   usbdmPage = null;
   
   public UsbdmConfigurationPage(UsbdmProjectTypeSelection usbdmPage) {
   ...
   public UsbdmConfigurationPage(String pageName, String title,
