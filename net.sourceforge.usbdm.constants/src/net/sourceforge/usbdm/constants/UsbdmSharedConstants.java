...
public class UsbdmSharedConstants {
   ...
   public final static String  ATTR_PROGRAM_TARGET                   = LAUNCH_ATTRIBUTE_KEY+"loadImage";                //$NON-NLS-1$

   public final static String  ATTR_USE_EXTERNAL_FILE                = LAUNCH_ATTRIBUTE_KEY+"useExternalFile";          //$NON-NLS-1$
   public final static String  ATTR_EXTERNAL_FILE_NAME               = LAUNCH_ATTRIBUTE_KEY+"externalFileName";         //$NON-NLS-1$

   // Not used
   public final static String  ATTR_USE_BINARY_OFFSET                = LAUNCH_ATTRIBUTE_KEY+"useBinaryOffset";          //$NON-NLS-1$
   public final static String  ATTR_BINARY_OFFSET_VALUE              = LAUNCH_ATTRIBUTE_KEY+"binaryOffset";             //$NON-NLS-1$

   public final static String  ATTR_SET_PC_REGISTER                  = LAUNCH_ATTRIBUTE_KEY+"setPcRegister";            //$NON-NLS-1$
   public final static String  ATTR_PC_REGISTER_VALUE                = LAUNCH_ATTRIBUTE_KEY+"pcRegisterValue";          //$NON-NLS-1$
   
   public final static String  ATTR_DO_STOP_AT_MAIN                  = LAUNCH_ATTRIBUTE_KEY+"doStopAtMain";             //$NON-NLS-1$
   public final static String  ATTR_STOP_AT_MAIN_ADDRESS             = LAUNCH_ATTRIBUTE_KEY+"stopAtMainAddress";        //$NON-NLS-1$

   public final static String  ATTR_DO_RESET                         = LAUNCH_ATTRIBUTE_KEY+"doReset";                  //$NON-NLS-1$
   public final static String  ATTR_DO_RESUME                        = LAUNCH_ATTRIBUTE_KEY+"doResume";                 //$NON-NLS-1$
   public final static String  ATTR_DO_HALT                          = LAUNCH_ATTRIBUTE_KEY+"doHalt";                   //$NON-NLS-1$
   
   public final static String  ATTR_INIT_COMMANDS                    = LAUNCH_ATTRIBUTE_KEY+"initCommands";             //$NON-NLS-1$
   public final static String  ATTR_RUN_COMMANDS                     = LAUNCH_ATTRIBUTE_KEY+"runCommands";              //$NON-NLS-1$
   
   public final static String  ATTR_USE_EXTERNAL_SYMBOL_FILE         = LAUNCH_ATTRIBUTE_KEY+"useExternalSymbolFile";    //$NON-NLS-1$
   public final static String  ATTR_EXTERNAL_SYMBOL_FILE_NAME        = LAUNCH_ATTRIBUTE_KEY+"externalSymbolFileName";   //$NON-NLS-1$

   // Not used
   public final static String  ATTR_USE_SYMBOLS_OFFSET               = LAUNCH_ATTRIBUTE_KEY+"useSymbolsOffset";         //$NON-NLS-1$
   public final static String  ATTR_SYMBOLS_OFFSET_VALUE             = LAUNCH_ATTRIBUTE_KEY+"symbolsOffset";            //$NON-NLS-1$

   public final static String  ATTR_RESTART_USES_STARTUP             = LAUNCH_ATTRIBUTE_KEY+"restartUsesStartup";       //$NON-NLS-1$
   
   public final static String  ATTR_RESTART_SET_PC_REGISTER          = LAUNCH_ATTRIBUTE_KEY+"restartSetPcRegister";     //$NON-NLS-1$
   public final static String  ATTR_RESTART_PC_REGISTER_VALUE        = LAUNCH_ATTRIBUTE_KEY+"restartPcRegisterValue";   //$NON-NLS-1$
   public final static String  ATTR_RESTART_DO_STOP_AT_MAIN          = LAUNCH_ATTRIBUTE_KEY+"restartDoStopAtMain";      //$NON-NLS-1$
   public final static String  ATTR_RESTART_STOP_AT_MAIN_ADDRESS     = LAUNCH_ATTRIBUTE_KEY+"restartStopAtMainAdress";  //$NON-NLS-1$
   public final static String  ATTR_RESTART_DO_RESUME                = LAUNCH_ATTRIBUTE_KEY+"restartDoResume";         //$NON-NLS-1$

   // Default - Load binary image
   public final static boolean DEFAULT_PROGRAM_TARGET                = true;

   public final static boolean DEFAULT_USE_EXTERNAL_FILE             = false;
   public final static String  DEFAULT_EXTERNAL_FILE_NAME            = "";                                              //$NON-NLS-1$
   ...
   public final static boolean DEFAULT_RESTART_USES_STARTUP          = true;
   public final static boolean DEFAULT_RESTART_SET_PC_REGISTER       = DEFAULT_SET_PC_REGISTER;
   public final static String  DEFAULT_RESTART_PC_REGISTER_VALUE     = DEFAULT_PC_REGISTER_VALUE;
   public final static boolean DEFAULT_RESTART_DO_STOP_AT_MAIN       = DEFAULT_DO_STOP_AT_MAIN;
   public final static String  DEFAULT_RESTART_STOP_AT_MAIN_ADDRESS  = DEFAULT_STOP_AT_MAIN_ADDRESS;
   public final static boolean DEFAULT_RESTART_DO_RESUME             = DEFAULT_DO_RESUME;
                                                                     
   public final static String  DEFAULT_INIT_COMMANDS                 = "";                                              //$NON-NLS-1$
   public final static String  DEFAULT_RUN_COMMANDS                  = "";                                              //$NON-NLS-1$

   // IDs used in plugin.xml etc
   public final static String USBDM_ARM_BUILD_TOOL_ID                     = "net.sourceforge.usbdm.cdt.arm.toolchain.buildtools";                                //$NON-NLS-1$
   public final static String USBDM_COLDFIRE_BUILD_TOOL_ID                = "net.sourceforge.usbdm.cdt.coldfire.toolchain.buildtools";                           //$NON-NLS-1$
   public final static String ARMLTD_ARM_BUILD_ID                         = "net.sourceforge.usbdm.cdt.toolchain.processor.usbdmConfigure.armLtdGnuToolsForARM"; //$NON-NLS-1$
   ...
   public final static String CODESOURCERY_ARM_PATH_VAR                   = "usbdm_codesourcery_arm_path";           //$NON-NLS-1$
   public final static String CODESOURCERY_ARM_PREFIX_VAR                 = "usbdm_codesourcery_arm_prefix";         //$NON-NLS-1$
   ...
   public final static String PATH_NOT_SET      = "PATH NOT SET";
   public final static String COMMAND_NOT_SET   = "COMMAND NOT SET";
   public final static String PREFIX_NOT_SET    = "PREFIX NOT SET";
