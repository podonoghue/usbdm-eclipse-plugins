...
public abstract class WriterBase {
   ...
   protected final DeviceFamily fDeviceFamily;
    ...
    */
   WriterBase(DeviceFamily deviceFamily) {
      this.fDeviceFamily = deviceFamily;
   }
   ...
   public boolean needPeripheralInformationClass() {
      ...
      if (!required) {
         ...
         if ((fOwner.getClockReg() != null) || (fOwner.getClockMask() != null)) {
            System.err.println("WARNING - Unexpected clock information for non-present peripheral " + fOwner.getPeripheralName());
            return false;
