...
import net.sourceforge.usbdm.configEditor.parser.ParseFamilyCSV;
import net.sourceforge.usbdm.configEditor.parser.WriteFamilyCpp;
...
public class TestCreateCpp {
   ...
   public static void main(String[] args) throws Exception {
      ...
      for (Path filePath : folderStream) {
         ...
         DeviceInfo deviceInfo = reader.processFile(filePath);
