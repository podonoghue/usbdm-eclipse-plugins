...
//      System.err.println("UsbdmGdbDsfLaunchConfigurationDelegate.launchDebugSession(...)");
   ...
   //   /** @since 4.1 */
   //   protected void launchDebugSessionX( final ILaunchConfiguration config, ILaunch l, IProgressMonitor progressMonitor ) throws CoreException {
   //      System.err.println("UsbdmGdbDsfLaunchConfigurationDelegate.launchDebugSession(...)#1");
   ...
   //
   //      monitor.worked(1);
   //      System.err.println("UsbdmGdbDsfLaunchConfigurationDelegate.launchDebugSession(...)#2");
   //
   ...
   //      System.err.println("UsbdmGdbDsfLaunchConfigurationDelegate.launchDebugSession(...)#3");
   //
   ...
   //      Sequence servicesLaunchSequence = getServicesSequence(launch.getSession(), launch, monitor.newChild(4));
   //
   ...
   //         }
   //      }
   //      System.err.println("UsbdmGdbDsfLaunchConfigurationDelegate.launchDebugSession(...)#4");
   //
   //      if (monitor.isCanceled()) {
   //         cleanupLaunch();
   //         return;
   ...
   //
   //      String x = getCLILabel(config, gdbVersion);
   //      System.err.println("UsbdmGdbDsfLaunchConfigurationDelegate.launchDebugSession(...)#5a "+x);
   //
   //      // Add the GDB process object to the launch.
   //      launch.addCLIProcess(getCLILabel(config, gdbVersion));
   //
   //      monitor.worked(1);
   //      System.err.println("UsbdmGdbDsfLaunchConfigurationDelegate.launchDebugSession(...)#5");
   //
   //      // Create and invoke the final launch sequence to setup GDB
   //      final IProgressMonitor subMon2 = monitor.newChild(4); 
   //
   //      Query<Object> completeLaunchQuery = new Query<Object>() {
   //         @Override
   //         protected void execute(final DataRequestMonitor<Object> rm) {
   //            System.err.println("UsbdmGdbDsfLaunchConfigurationDelegate.launchDebugSession(...)#6.1");
   ...
   //      succeed = false;
   //      try {
   //         System.err.println("UsbdmGdbDsfLaunchConfigurationDelegate.launchDebugSession(...)#6");
   //         completeLaunchQuery.get(20, TimeUnit.SECONDS);
   //         System.err.println("UsbdmGdbDsfLaunchConfigurationDelegate.launchDebugSession(...)#7");
   //         succeed = true;
   //      } catch (InterruptedException e1) {
   //         throw new DebugException(new Status(IStatus.ERROR, GdbPlugin.PLUGIN_ID, DebugException.INTERNAL_ERROR, "Interrupted Exception in dispatch thread", e1)); //$NON-NLS-1$
   //      } catch (ExecutionException e1) {
   //         Activator.error("Exception in execute", e1);
   //         e1.printStackTrace();
   ...
   //         System.err.println("UsbdmGdbDsfLaunchConfigurationDelegate.launchDebugSession(...)#6 - timeout");
   //         e.printStackTrace();
   //      } finally {
   //         if (!succeed) {
   ...
   //      System.err.println("UsbdmGdbDsfLaunchConfigurationDelegate.cleanupLaunch(...)");
