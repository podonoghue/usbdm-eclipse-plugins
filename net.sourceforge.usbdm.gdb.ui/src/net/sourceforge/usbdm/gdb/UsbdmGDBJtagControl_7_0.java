 ...
 * Use for GDB >= 7.0
 */
public class UsbdmGDBJtagControl_7_0 extends GDBControl_7_0 {

   GdbServerParameters fGdbServerParameters;

	public UsbdmGDBJtagControl_7_0(DsfSession session, ILaunchConfiguration config, CommandFactory factory, GdbServerParameters gdbServerParameters) {
