...
public class ClockValidate_MKxx extends MyValidator {
   ...
   public void validate(TreeViewer viewer) throws Exception {
      ...
      else if ((system_bus_clock/system_flash_clock)*system_flash_clock != system_bus_clock) {
         system_flash_clockMessage = "Clock frequency must be an integer divisor of Bus clock frequency";
      }
