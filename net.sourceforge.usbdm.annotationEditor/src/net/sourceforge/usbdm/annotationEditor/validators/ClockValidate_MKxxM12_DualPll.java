...
public class ClockValidate_MKxxM12_DualPll extends MyValidator {
   ...
   public ClockValidate_MKxxM12_DualPll(long maxCoreClockfrequency, long maxBusClockFrequency, long maxFlashClockFrequency, long maxFlexbusFrequency) {
   ...
   public ClockValidate_MKxxM12_DualPll() {
      this(150000000, 75000000, 25000000, 50000000);
   }
...
//      System.err.println("ClockValidate.validate() system_erc_clock = " + system_erc_clock);
      ...
      Message system_core_clockMessage = 
            new Message(String.format("Must be <= %2.2f MHz.", MAX_CORE_CLOCK_FREQ/1000000.0), Severity.INFORMATION);
      ...
      Message system_bus_clockMessage = 
            new Message(String.format("Must be <= %2.2f MHz.", MAX_BUS_CLOCK_FREQ/1000000.0), Severity.INFORMATION);
      if (system_bus_clock > MAX_BUS_CLOCK_FREQ) {
         ...
         system_bus_clockMessage = new Message("Clock frequency must be an integer divisor of Core clock frequency");
      }
      ...
      if (sim_clkdiv1_outdiv3Node != null) {
         ...
         Message system_flexbus_clockMessage = 
               new Message(String.format("Must be <= %2.2f MHz.", MAX_FLEXBUS_CLOCK_FREQ/1000000.0), Severity.INFORMATION);
      ...
      Message system_flash_clockMessage =  
            new Message(String.format("Must be <= %2.2f MHz.", MAX_FLASH_CLOCK_FREQ/1000000.0), Severity.INFORMATION);
