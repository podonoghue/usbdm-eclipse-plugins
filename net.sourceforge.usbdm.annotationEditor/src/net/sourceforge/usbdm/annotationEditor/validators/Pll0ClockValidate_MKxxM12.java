...
public class Pll0ClockValidate_MKxxM12 extends MyValidator {
   ...
   public void validate(final TreeViewer viewer) throws Exception {
      ...
      NumericOptionModelNode pllTargetFrequencyNode =  getNumericModelNode("pll0TargetFrequency");
      BinaryOptionModelNode  mcg_pllrefselNode      =  getBinaryModelNode("mcg_c5_pllrefsel0");
