...
//      return warningImage;
   ...
   public static PinBooleanColumnLabelProvider getLk() {
      return new PinBooleanColumnLabelProvider(MappingInfo.PORT_PCR_LK_MASK, MappingInfo.PORT_PCR_LK_SHIFT) {
         @Override
   ...
   public static PinBooleanColumnLabelProvider getDse() {
      return new PinBooleanColumnLabelProvider(MappingInfo.PORT_PCR_DSE_MASK, MappingInfo.PORT_PCR_DSE_SHIFT) {
         @Override
         public String getToolTipText(Object element) {
   ...
   public static PinBooleanColumnLabelProvider getOde() {
      return new PinBooleanColumnLabelProvider(MappingInfo.PORT_PCR_ODE_MASK, MappingInfo.PORT_PCR_ODE_SHIFT) {
         @Override
         public String getToolTipText(Object element) {
   ...
   public static PinBooleanColumnLabelProvider getPfe() {
      return new PinBooleanColumnLabelProvider(MappingInfo.PORT_PCR_PFE_MASK, MappingInfo.PORT_PCR_PFE_SHIFT) {
         @Override
         public String getToolTipText(Object element) {
   ...
   public static PinBooleanColumnLabelProvider getSre() {
      return new PinBooleanColumnLabelProvider(MappingInfo.PORT_PCR_SRE_MASK, MappingInfo.PORT_PCR_SRE_SHIFT) {
         @Override
         public String getToolTipText(Object element) {
