...
public final class DeviceInformationModel extends TreeViewModel implements IPage {
   ...
   public DeviceInformationModel(BaseModel parent, DeviceInfo deviceInfo) {
      ...
      new ConstantModel(this, "Device Sub-family", "Family for this device", deviceInfo.getDeviceSubFamily());
      new ConstantModel(this, "Hardware File", "File describing this device family", deviceInfo.getSourceFilename());
      new DeviceVariantModel(this, deviceInfo);
      new DevicePackageModel(this, deviceInfo);
      new DeviceNameModel(this, deviceInfo);

      // Add information from XML menu file
               ...
               setEditor(new TreeEditor() {
                  ...
                  protected TreeColumnInformation[] getColumnInformation(TreeViewer viewer) {
                     final TreeColumnInformation[] fColumnInformation = {
                           new TreeColumnInformation("Property Name", 300, new NameColumnLabelProvider(),        null, "Name of the property" ),
                           new TreeColumnInformation("Value",         550, new ValueColumnLabelProvider(),       new ValueColumnEditingSupport(viewer) ),
