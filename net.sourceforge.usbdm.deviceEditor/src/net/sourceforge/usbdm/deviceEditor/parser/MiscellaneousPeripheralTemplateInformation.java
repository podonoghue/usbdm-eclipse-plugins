...
public class MiscellaneousPeripheralTemplateInformation extends PeripheralTemplateInformation {
   ...
   public MiscellaneousPeripheralTemplateInformation(DeviceInfo deviceInfo, DeviceFamily deviceFamily) throws Exception {
      super(deviceInfo, deviceFamily, "Misc", "MISC", "", WriterForMiscellaneous.class);
   }
   ...
   public PeripheralFunction appliesTo(DeviceInfo factory, String name) {         
      ...
      for (PinDescription pinNamePattern:pinNamePatterns) {
         ...
         peripheralFunction = factory.createPeripheralFunction(name, "MISC", "MISC", matcher.group(1)+matcher.group(2)+matcher.group(3));
      }
