...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         /* ADC0_SE0        = PTE20 (A2)                     */  { PORTE_CLOCK_MASK, PORTE_BasePtr,  GPIOE_BasePtr,  20,  0  },
         /* ADC0_SE1        = PTE16 (A0)                     */  { PORTE_CLOCK_MASK, PORTE_BasePtr,  GPIOE_BasePtr,  16,  0  },
         ...
         /* ADC0_SE8        = PTB0 (A5)                      */  { PORTB_CLOCK_MASK, PORTB_BasePtr,  GPIOB_BasePtr,  0,   0  },
         /* ADC0_SE9        = PTB1 (A4)                      */  { PORTB_CLOCK_MASK, PORTB_BasePtr,  GPIOB_BasePtr,  1,   0  },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* ADC0_SE11       = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* ADC0_SE12       = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* ADC0_SE13       = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* ADC0_SE14       = PTC0 (A1)                      */  { PORTC_CLOCK_MASK, PORTC_BasePtr,  GPIOC_BasePtr,  0,   0  },
         ...
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* ADC0_SE4a       = PTE21 (A3)                     */  { PORTE_CLOCK_MASK, PORTE_BasePtr,  GPIOE_BasePtr,  21,  0  },
   ...
   public:
      ...
      static constexpr PcrInfo  info[] = {
            ...
            // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
            /* ADC0_DP0        = PTE20 (A2)                     */  { PORTE_CLOCK_MASK, PORTE_BasePtr,  GPIOE_BasePtr,  20,  0  },
            /* ADC0_DP1        = PTE16 (A0)                     */  { PORTE_CLOCK_MASK, PORTE_BasePtr,  GPIOE_BasePtr,  16,  0  },
   ...
   public:
      ...
      static constexpr PcrInfo  info[] = {
            ...
            // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
            /* ADC0_DM0        = PTE21 (A3)                     */  { PORTE_CLOCK_MASK, PORTE_BasePtr,  GPIOE_BasePtr,  21,  0  },
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
         /* I2C1_SCL        = PTD7 (D15/ONBOARD_SCL)         */  { PORTD_CLOCK_MASK, PORTD_BasePtr,  GPIOD_BasePtr,  7,   4  },
         /* I2C1_SDA        = PTD6 (D14/ONBOARD_SDA)         */  { PORTD_CLOCK_MASK, PORTD_BasePtr,  GPIOD_BasePtr,  6,   4  },
   };
};
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         /* LLWU_P8         = PTC4 (D10)                     */  { PORTC_CLOCK_MASK, PORTC_BasePtr,  GPIOC_BasePtr,  4,   1  },
         /* LLWU_P9         = PTC5 (D13)                     */  { PORTC_CLOCK_MASK, PORTC_BasePtr,  GPIOC_BasePtr,  5,   1  },
         /* LLWU_P10        = PTC6 (D11)                     */  { PORTC_CLOCK_MASK, PORTC_BasePtr,  GPIOC_BasePtr,  6,   1  },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
         /* TPM0_CH0        = PTE24 (D5)                     */  { PORTE_CLOCK_MASK, PORTE_BasePtr,  GPIOE_BasePtr,  24,  3  },
         /* TPM0_CH1        = PTE25 (D3)                     */  { PORTE_CLOCK_MASK, PORTE_BasePtr,  GPIOE_BasePtr,  25,  3  },
         /* TPM0_CH2        = PTA5 (D9)                      */  { PORTA_CLOCK_MASK, PORTA_BasePtr,  GPIOA_BasePtr,  5,   3  },
         /* TPM0_CH3        = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* TPM0_CH4        = PTE31 (D8)                     */  { PORTE_CLOCK_MASK, PORTE_BasePtr,  GPIOE_BasePtr,  31,  3  },
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
         /* TPM1_CH0        = PTA12 (D2)                     */  { PORTA_CLOCK_MASK, PORTA_BasePtr,  GPIOA_BasePtr,  12,  3  },
         /* TPM1_CH1        = PTA13 (D4/LED_BLUE)            */  { PORTA_CLOCK_MASK, PORTA_BasePtr,  GPIOA_BasePtr,  13,  3  },
   };
};
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
         /* TPM2_CH0        = PTA1 (D0)                      */  { PORTA_CLOCK_MASK, PORTA_BasePtr,  GPIOA_BasePtr,  1,   3  },
         /* TPM2_CH1        = PTA2 (D1)                      */  { PORTA_CLOCK_MASK, PORTA_BasePtr,  GPIOA_BasePtr,  2,   3  },
   };
};
 ...
 *  PTB16                    | Disabled                                    |                     | -       
 *  PTB17                    | Disabled                                    |                     | -       
 *  PTB18                    | Disabled                                    | LED_RED             | -       
 *  PTB19                    | Disabled                                    | LED_GREEN           | -       
 *  PTC0                     | ADC0_SE14                                   | A1                  | -       
 *  PTC1                     | ADC0_SE15                                   |                     | -       
 *  PTC2                     | ADC0_SE11                                   | MAG_INT             | -       
 *  PTC3                     | Disabled                                    |                     | -       
 ...
 *  PTE22                    | ADC0_DP3/ADC0_SE3                           |                     | -       
 *  PTE23                    | ADC0_DM3/ADC0_SE7a                          |                     | -       
 *  PTE24                    | TPM0_CH0                                    | D5                  | -       
 *  PTE25                    | TPM0_CH1                                    | D3                  | -       
 *  PTE29                    | CMP0_IN5/ADC0_SE4b                          |                     | -       
 *  PTE30                    | ADC0_SE23/CMP0_IN4                          |                     | -       
 *  PTE31                    | TPM0_CH4                                    | D8                  | -       
 *  USB0_DM                  | USB0_DM                                     |                     | -       
 *  USB0_DP                  | USB0_DP                                     |                     | -       
 *  USB_VDD                  | USB_VDD                                     |                     | -       
