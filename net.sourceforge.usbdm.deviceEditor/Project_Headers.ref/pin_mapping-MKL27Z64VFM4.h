 ...
 * @version   1.2.0
 * @brief     Pin declarations for MKL27Z64VFM4
 *
 * *****************************
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         /* ADC0_SE8        = PTB0 (p20)                     */  { PORTB_CLOCK_MASK, PORTB_BasePtr,  GPIOB_BasePtr,  0,   0  },
         /* ADC0_SE9        = PTB1 (p21)                     */  { PORTB_CLOCK_MASK, PORTB_BasePtr,  GPIOB_BasePtr,  1,   0  },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
         /* I2C1_SCL        = PTD7 (p32)                     */  { PORTD_CLOCK_MASK, PORTD_BasePtr,  GPIOD_BasePtr,  7,   4  },
         /* I2C1_SDA        = PTD6 (p31)                     */  { PORTD_CLOCK_MASK, PORTD_BasePtr,  GPIOD_BasePtr,  6,   4  },
   };
};
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         /* LLWU_P8         = PTC4 (p25)                     */  { PORTC_CLOCK_MASK, PORTC_BasePtr,  GPIOC_BasePtr,  4,   1  },
         /* LLWU_P9         = PTC5 (p26)                     */  { PORTC_CLOCK_MASK, PORTC_BasePtr,  GPIOC_BasePtr,  5,   1  },
         /* LLWU_P10        = PTC6 (p27)                     */  { PORTC_CLOCK_MASK, PORTC_BasePtr,  GPIOC_BasePtr,  6,   1  },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
         /* TPM2_CH0        = PTA1 (p11)                     */  { PORTA_CLOCK_MASK, PORTA_BasePtr,  GPIOA_BasePtr,  1,   3  },
         /* TPM2_CH1        = PTA2 (p12)                     */  { PORTA_CLOCK_MASK, PORTA_BasePtr,  GPIOA_BasePtr,  2,   3  },
   };
};
...
using adc_p20              = const USBDM::Adc0<8>;
using adc_p21              = const USBDM::Adc0<9>;
...
using gpio_p25             = const USBDM::GpioC<4>;
using gpio_p26             = const USBDM::GpioC<5>;
using gpio_p27             = const USBDM::GpioC<6>;
using gpio_p28             = const USBDM::GpioC<7>;
/**
...
using tpm_p11              = const USBDM::Tpm2<0>;
using tpm_p12              = const USBDM::Tpm2<1>;
/** 
 * End TPM_Group
 * @}
 */
 ...
 *  PTC2                     | ADC0_SE11                                   | p23                 | -       
 *  PTC3                     | Disabled                                    | p24                 | -       
 *  PTC4                     | GPIOC_4/LLWU_P8                             | p25                 | -       
 *  PTC5                     | GPIOC_5/LLWU_P9                             | p26                 | -       
 *  PTC6                     | GPIOC_6/LLWU_P10                            | p27                 | -       
 *  PTC7                     | GPIOC_7                                     | p28                 | -       
 *  PTD4                     | Disabled                                    | p29                 | -       
 *  PTD5                     | ADC0_SE6b                                   | p30                 | -       
 *  PTD6                     | I2C1_SDA                                    | p31                 | -       
