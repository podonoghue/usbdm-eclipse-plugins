/**
 * @file      pin_mapping.h (derived from MK22FA12.csv)
 * @version   1.2.0
 * @brief     Pin declarations for MK22FX512AVLH12
 *
 * *****************************
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* ADC0_SE23       = DAC0_OUT (p18)                 */  { 0, 0, 0, FIXED_NO_PCR, 0 },
   };
   class InfoDP {
   public:
      //! Information for each signal of peripheral
      static constexpr PcrInfo  info[] = {
            ...
            /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
            /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
            /* ADC0_DP3        = ADC1_DP0 (p11)                 */  { 0, 0, 0, FIXED_NO_PCR, 0 },
      };
   }; 
   class InfoDM {
   public:
      ...
      static constexpr PcrInfo  info[] = {
            ...
            /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
            /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
            /* ADC0_DM3        = ADC1_DM0 (p12)                 */  { 0, 0, 0, FIXED_NO_PCR, 0 },
      };
   }; 
};
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* ADC1_SE18       = VREF_OUT (p17)                 */  { 0, 0, 0, FIXED_NO_PCR, 0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
   ...
   public:
      ...
      static constexpr PcrInfo  info[] = {
            ...
            // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
            /* ADC1_DP0        = ADC1_DP0 (p11)                 */  { 0, 0, 0, FIXED_NO_PCR, 0 },
            /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
            /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
            /* ADC1_DP3        = ADC0_DP0 (p9)                  */  { 0, 0, 0, FIXED_NO_PCR, 0 },
      };
   }; 
   class InfoDM {
   public:
      ...
      static constexpr PcrInfo  info[] = {
            ...
            // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
            /* ADC1_DM0        = ADC1_DM0 (p12)                 */  { 0, 0, 0, FIXED_NO_PCR, 0 },
            /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
            /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
            /* ADC1_DM3        = ADC0_DM0 (p10)                 */  { 0, 0, 0, FIXED_NO_PCR, 0 },
      };
   }; 
};
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* CMP1_IN3        = DAC0_OUT (p18)                 */  { 0, 0, 0, FIXED_NO_PCR, 0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
 ...
 */
/**
 * @addtogroup DAC1_Group DAC1, Misc
 * @brief Pins used for Misc
 * @{
 */
/** 
 ...
 *  ------------------------ | --------------------------------------------|---------------------| ------------- 
 *  ADC0_DM0                 | ADC0_DM0/ADC1_DM3                           | p10                 | -       
 *  ADC0_DP0                 | ADC0_DP0/ADC1_DP3                           | p9                  | -       
 *  ADC1_DM0                 | ADC1_DM0/ADC0_DM3                           | p12                 | -       
 *  ADC1_DP0                 | ADC1_DP0/ADC0_DP3                           | p11                 | -       
 *  DAC0_OUT                 | DAC0_OUT/CMP1_IN3/ADC0_SE23                 | p18                 | -       
 *  EXTAL32                  | EXTAL32                                     | p20                 | -       
 *  PTA0                     | JTAG_TCLK/SWD_CLK/EZP_CLK                   | p22                 | -       
 *  PTA1                     | JTAG_TDI/EZP_DI                             | p23                 | -       
 *  PTA2                     | JTAG_TDO/TRACE_SWO/EZP_DO                   | p24                 | -       
 *  PTA3                     | JTAG_TMS/SWD_DIO                            | p25                 | -       
 *  PTA4                     | NMI_b/EZP_CS_b                              | p26                 | -       
 *  PTA5                     | JTAG_TRST_b                                 | p27                 | -       
 *  PTA12                    | CMP2_IN0                                    | p28                 | -       
 *  PTA13                    | CMP2_IN1                                    | p29                 | -       
 *  PTA18                    | EXTAL0                                      | p32                 | -       
 *  PTA19                    | XTAL0                                       | p33                 | -       
 *  PTB0                     | ADC0_SE8/ADC1_SE8                           | p35                 | -       
 *  PTB1                     | ADC0_SE9/ADC1_SE9                           | p36                 | -       
 *  PTB2                     | ADC0_SE12                                   | p37                 | -       
 *  PTB3                     | ADC0_SE13                                   | p38                 | -       
 *  PTB16                    | Disabled                                    | p39                 | -       
 *  PTB17                    | Disabled                                    | p40                 | -       
 ...
 *  PTC0                     | ADC0_SE14                                   | p43                 | -       
 *  PTC1                     | ADC0_SE15                                   | p44                 | -       
 *  PTC2                     | ADC0_SE4b/CMP1_IN0                          | p45                 | -       
 *  PTC3                     | CMP1_IN1                                    | p46                 | -       
 *  PTC4                     | Disabled                                    | p49                 | -       
 *  PTC5                     | Disabled                                    | p50                 | -       
 *  PTC6                     | CMP0_IN0                                    | p51                 | -       
 *  PTC7                     | CMP0_IN1                                    | p52                 | -       
 *  PTC8                     | ADC1_SE4b/CMP0_IN2                          | p53                 | -       
 *  PTC9                     | ADC1_SE5b/CMP0_IN3                          | p54                 | -       
 *  PTC10                    | ADC1_SE6b                                   | p55                 | -       
 *  PTC11                    | ADC1_SE7b                                   | p56                 | -       
 *  PTD0                     | Disabled                                    | p57                 | -       
 *  PTD1                     | ADC0_SE5b                                   | p58                 | -       
 ...
 *  VREFH                    | VREFH                                       | p14                 | -       
 *  VREFL                    | VREFL                                       | p15                 | -       
 *  VREF_OUT                 | VREF_OUT/CMP1_IN5/CMP0_IN5/ADC1_SE18        | p17                 | -       
 *  VREGIN                   | VREGIN                                      | p8                  | -       
 *  VSS1                     | VSS1                                        | p4                  | -       
 *  VSS2                     | VSS2                                        | p31                 | -       
 *  VSS3                     | VSS3                                        | p48                 | -       
