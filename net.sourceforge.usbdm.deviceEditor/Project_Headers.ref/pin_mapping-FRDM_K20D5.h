...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         /* ADC0_SE0        = ADC0_DP0                       */  { 0, 0, 0, FIXED_NO_PCR, 0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* ADC0_SE3        = ADC0_DP3                       */  { 0, 0, 0, FIXED_NO_PCR, 0 },
         ...
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* ADC0_SE19       = ADC0_DM0                       */  { 0, 0, 0, FIXED_NO_PCR, 0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* ADC0_SE21       = ADC0_DM3                       */  { 0, 0, 0, FIXED_NO_PCR, 0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* ADC0_SE23       = ADC0_SE23                      */  { 0, 0, 0, FIXED_NO_PCR, 0 },
   };
   class InfoDP {
   public:
      //! Information for each signal of peripheral
      static constexpr PcrInfo  info[] = {
            ...
            /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
            /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
            /* ADC0_DP3        = ADC0_DP3                       */  { 0, 0, 0, FIXED_NO_PCR, 0 },
      };
   }; 
   class InfoDM {
   public:
      ...
      static constexpr PcrInfo  info[] = {
            ...
            /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
            /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
            /* ADC0_DM3        = ADC0_DM3                       */  { 0, 0, 0, FIXED_NO_PCR, 0 },
      };
   }; 
};
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* CMP1_IN3        = ADC0_SE23                      */  { 0, 0, 0, FIXED_NO_PCR, 0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
 ...
 *  ------------------------ | --------------------------------------------|---------------------| ------------- 
 *  ADC0_DM0                 | ADC0_DM0/ADC0_SE19                          |                     | -       
 *  ADC0_DM3                 | ADC0_DM3/ADC0_SE21                          |                     | -       
 *  ADC0_DP0                 | ADC0_DP0/ADC0_SE0                           |                     | -       
 *  ADC0_DP3                 | ADC0_DP3/ADC0_SE3                           |                     | -       
 *  ADC0_SE23                | ADC0_SE23/CMP1_IN3                          |                     | -       
 *  EXTAL32                  | EXTAL32                                     | EXTAL32             | -       
 *  PTA0                     | JTAG_TCLK/SWD_CLK                           | SWD_CLK             | -       
 *  PTA1                     | JTAG_TDI                                    | D5                  | -       
 *  PTA2                     | JTAG_TDO/TRACE_SWO                          | D9/LED_BLUE         | -       
 ...
 *  PTA18                    | EXTAL0                                      | EXTAL0              | -       
 *  PTA19                    | XTAL0                                       | XTAL0               | -       
 *  PTB0                     | ADC0_SE8/TSI0_CH0                           | A5/ACC_SCL          | -       
 *  PTB1                     | ADC0_SE9/TSI0_CH6                           | A4/ACC_SDA          | -       
 ...
 *  PTC2                     | ADC0_SE4b/CMP1_IN0/TSI0_CH15                | D10                 | -       
 ...
 *  VREFH                    | VREFH                                       | VREFH               | -       
 *  VREFL                    | VREFL                                       | VREFL               | -       
 *  VREF_OUT                 | VREF_OUT/CMP1_IN5/CMP0_IN5                  |                     | -       
