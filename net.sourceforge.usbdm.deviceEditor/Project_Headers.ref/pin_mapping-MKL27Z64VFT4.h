 ...
 * @version   1.2.0
 * @brief     Pin declarations for MKL27Z64VFT4
 *
 * *****************************
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         /* ADC0_SE0        = PTE20 (p7)                     */  { PORTE_CLOCK_MASK, PORTE_BasePtr,  GPIOE_BasePtr,  20,  0  },
         /* ADC0_SE1        = PTE16 (p6)                     */  { PORTE_CLOCK_MASK, PORTE_BasePtr,  GPIOE_BasePtr,  16,  0  },
         ...
         /* ADC0_SE8        = PTB0 (p27)                     */  { PORTB_CLOCK_MASK, PORTB_BasePtr,  GPIOB_BasePtr,  0,   0  },
         /* ADC0_SE9        = PTB1 (p28)                     */  { PORTB_CLOCK_MASK, PORTB_BasePtr,  GPIOB_BasePtr,  1,   0  },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* ADC0_SE11       = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* ADC0_SE12       = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* ADC0_SE13       = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* ADC0_SE14       = PTC0 (p33)                     */  { PORTC_CLOCK_MASK, PORTC_BasePtr,  GPIOC_BasePtr,  0,   0  },
         ...
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* ADC0_SE4a       = PTE21 (p8)                     */  { PORTE_CLOCK_MASK, PORTE_BasePtr,  GPIOE_BasePtr,  21,  0  },
   ...
   public:
      ...
      static constexpr PcrInfo  info[] = {
            ...
            // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
            /* ADC0_DP0        = PTE20 (p7)                     */  { PORTE_CLOCK_MASK, PORTE_BasePtr,  GPIOE_BasePtr,  20,  0  },
            /* ADC0_DP1        = PTE16 (p6)                     */  { PORTE_CLOCK_MASK, PORTE_BasePtr,  GPIOE_BasePtr,  16,  0  },
   ...
   public:
      ...
      static constexpr PcrInfo  info[] = {
            ...
            // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
            /* ADC0_DM0        = PTE21 (p8)                     */  { PORTE_CLOCK_MASK, PORTE_BasePtr,  GPIOE_BasePtr,  21,  0  },
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
         /* I2C1_SCL        = PTD7 (p48)                     */  { PORTD_CLOCK_MASK, PORTD_BasePtr,  GPIOD_BasePtr,  7,   4  },
         /* I2C1_SDA        = PTD6 (p47)                     */  { PORTD_CLOCK_MASK, PORTD_BasePtr,  GPIOD_BasePtr,  6,   4  },
   };
};
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         /* LLWU_P8         = PTC4 (p37)                     */  { PORTC_CLOCK_MASK, PORTC_BasePtr,  GPIOC_BasePtr,  4,   1  },
         /* LLWU_P9         = PTC5 (p38)                     */  { PORTC_CLOCK_MASK, PORTC_BasePtr,  GPIOC_BasePtr,  5,   1  },
         /* LLWU_P10        = PTC6 (p39)                     */  { PORTC_CLOCK_MASK, PORTC_BasePtr,  GPIOC_BasePtr,  6,   1  },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
         /* TPM0_CH0        = PTE24 (p15)                    */  { PORTE_CLOCK_MASK, PORTE_BasePtr,  GPIOE_BasePtr,  24,  3  },
         /* TPM0_CH1        = PTE25 (p16)                    */  { PORTE_CLOCK_MASK, PORTE_BasePtr,  GPIOE_BasePtr,  25,  3  },
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
         /* TPM2_CH0        = PTA1 (p18)                     */  { PORTA_CLOCK_MASK, PORTA_BasePtr,  GPIOA_BasePtr,  1,   3  },
         /* TPM2_CH1        = PTA2 (p19)                     */  { PORTA_CLOCK_MASK, PORTA_BasePtr,  GPIOA_BasePtr,  2,   3  },
   };
};
...
using adc_p27              = const USBDM::Adc0<8>;
using adc_p28              = const USBDM::Adc0<9>;
using adc_p33              = const USBDM::Adc0<14>;
using adc_p6               = const USBDM::Adc0<1>;
using adc_p7               = const USBDM::Adc0<0>;
using adc_p8               = const USBDM::Adc0<36>;
/** 
 * End ADC_Group
 * @}
 */
...
using gpio_p40             = const USBDM::GpioC<7>;
/**
...
using tpm_p15              = const USBDM::Tpm0<0>;
using tpm_p16              = const USBDM::Tpm0<1>;
/**
 * Convenience template class representing a TPM
 *
 * Example
...
using tpm_p18              = const USBDM::Tpm2<0>;
using tpm_p19              = const USBDM::Tpm2<1>;
/** 
 * End TPM_Group
 * @}
 */
 ...
 *  PTC2                     | ADC0_SE11                                   | p35                 | -       
 *  PTC3                     | Disabled                                    | p36                 | -       
 *  PTC4                     | GPIOC_4/LLWU_P8                             | p37                 | -       
 *  PTC5                     | GPIOC_5/LLWU_P9                             | p38                 | -       
 *  PTC6                     | GPIOC_6/LLWU_P10                            | p39                 | -       
 *  PTC7                     | GPIOC_7                                     | p40                 | -       
 *  PTD0                     | Disabled                                    | p41                 | -       
 *  PTD1                     | ADC0_SE5b                                   | p42                 | -       
 *  PTD2                     | Disabled                                    | p43                 | -       
 ...
 *  PTD6                     | I2C1_SDA                                    | p47                 | -       
 *  PTD7                     | I2C1_SCL                                    | p48                 | -       
 *  PTE16                    | ADC0_DP1/ADC0_SE1                           | p6                  | -       
 *  PTE20                    | ADC0_DP0/ADC0_SE0                           | p7                  | -       
 *  PTE21                    | ADC0_DM0/ADC0_SE4a                          | p8                  | -       
 *  PTE24                    | TPM0_CH0                                    | p15                 | -       
 *  PTE25                    | TPM0_CH1                                    | p16                 | -       
 *  PTE29                    | CMP0_IN5/ADC0_SE4b                          | p13                 | -       
 *  PTE30                    | ADC0_SE23/CMP0_IN4                          | p14                 | -       
 *  USB0_DM                  | USB0_DM                                     | p4                  | -       
 *  USB0_DP                  | USB0_DP                                     | p3                  | -       
 *  USB_VDD                  | USB_VDD                                     | p5                  | -       
 *  VDD1                     | VDD1                                        | p1                  | -       
