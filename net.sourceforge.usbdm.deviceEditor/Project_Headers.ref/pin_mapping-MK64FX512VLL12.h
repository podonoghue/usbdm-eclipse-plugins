 ...
 * @version   1.2.0
 * @brief     Pin declarations for MK64FX512VLL12
 *
 * *****************************
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         /* ADC0_SE23       = DAC0_OUT (p27)                 */  { 0, 0, 0, FIXED_NO_PCR, 0 },
   };
   class InfoDP {
   public:
      //! Information for each signal of peripheral
      static constexpr PcrInfo  info[] = {
            ...
            // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
            /* ADC0_DP0        = ADC0_DP0 (p18)                 */  { 0, 0, 0, FIXED_NO_PCR, 0 },
            /* ADC0_DP1        = ADC0_DP1 (p14)                 */  { 0, 0, 0, FIXED_NO_PCR, 0 },
            /* ADC0_DP2        = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
            /* ADC0_DP3        = ADC1_DP0 (p20)                 */  { 0, 0, 0, FIXED_NO_PCR, 0 },
      };
   }; 
   class InfoDM {
   public:
      ...
      static constexpr PcrInfo  info[] = {
            ...
            // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
            /* ADC0_DM0        = ADC0_DM0 (p19)                 */  { 0, 0, 0, FIXED_NO_PCR, 0 },
            /* ADC0_DM1        = ADC0_DM1 (p15)                 */  { 0, 0, 0, FIXED_NO_PCR, 0 },
            /* ADC0_DM2        = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
            /* ADC0_DM3        = ADC1_DM0 (p21)                 */  { 0, 0, 0, FIXED_NO_PCR, 0 },
      };
   }; 
};
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         /* ADC1_SE18       = VREF_OUT (p26)                 */  { 0, 0, 0, FIXED_NO_PCR, 0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
   ...
   public:
      ...
      static constexpr PcrInfo  info[] = {
            ...
            // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
            /* ADC1_DP0        = ADC1_DP0 (p20)                 */  { 0, 0, 0, FIXED_NO_PCR, 0 },
            /* ADC1_DP1        = ADC1_DP1 (p16)                 */  { 0, 0, 0, FIXED_NO_PCR, 0 },
            /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
            /* ADC1_DP3        = ADC0_DP0 (p18)                 */  { 0, 0, 0, FIXED_NO_PCR, 0 },
      };
   }; 
   class InfoDM {
   public:
      ...
      static constexpr PcrInfo  info[] = {
            ...
            // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
            /* ADC1_DM0        = ADC1_DM0 (p21)                 */  { 0, 0, 0, FIXED_NO_PCR, 0 },
            /* ADC1_DM1        = ADC1_DM1 (p17)                 */  { 0, 0, 0, FIXED_NO_PCR, 0 },
            /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
            /* ADC1_DM3        = ADC0_DM0 (p19)                 */  { 0, 0, 0, FIXED_NO_PCR, 0 },
      };
   }; 
};
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         /* CMP0_IN5        = VREF_OUT (p26)                 */  { 0, 0, 0, FIXED_NO_PCR, 0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         /* CMP1_IN3        = DAC0_OUT (p27)                 */  { 0, 0, 0, FIXED_NO_PCR, 0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* CMP1_IN5        = VREF_OUT (p26)                 */  { 0, 0, 0, FIXED_NO_PCR, 0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
         /* VREF_OUT        = VREF_OUT (p26)                 */  { 0, 0, 0, FIXED_NO_PCR, 0 },
   };
};
...
using adc_p27              = const USBDM::Adc0<23>;
/**
 * Convenience templated class representing an ADC
 *
 * Example
...
using adc_p26              = const USBDM::Adc1<18>;
/** 
 * End ADC_Group
 * @}
 */
 ...
 *  ADC1_DM1                 | ADC1_DM1                                    | p17                 | -       
 *  ADC1_DP0                 | ADC1_DP0/ADC0_DP3                           | p20                 | -       
 *  ADC1_DP1                 | ADC1_DP1                                    | p16                 | -       
 *  DAC0_OUT                 | DAC0_OUT/CMP1_IN3/ADC0_SE23                 | p27                 | -       
 *  EXTAL32                  | EXTAL32                                     | p29                 | -       
 *  PTA0                     | JTAG_TCLK/SWD_CLK                           | p34                 | -       
 *  PTA1                     | JTAG_TDI                                    | p35                 | -       
 *  PTA2                     | JTAG_TDO/TRACE_SWO                          | p36                 | -       
