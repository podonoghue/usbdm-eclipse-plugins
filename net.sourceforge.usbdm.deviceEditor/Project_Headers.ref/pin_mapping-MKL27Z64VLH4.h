 ...
 * @version   1.2.0
 * @brief     Pin declarations for MKL27Z64VLH4
 *
 * *****************************
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         /* ADC0_SE0        = PTE20 (p9)                     */  { PORTE_CLOCK_MASK, PORTE_BasePtr,  GPIOE_BasePtr,  20,  0  },
         /* ADC0_SE1        = PTE16 (p8)                     */  { PORTE_CLOCK_MASK, PORTE_BasePtr,  GPIOE_BasePtr,  16,  0  },
         ...
         /* ADC0_SE14       = PTC0 (p43)                     */  { PORTC_CLOCK_MASK, PORTC_BasePtr,  GPIOC_BasePtr,  0,   0  },
         ...
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* ADC0_SE4a       = PTE21 (p10)                    */  { PORTE_CLOCK_MASK, PORTE_BasePtr,  GPIOE_BasePtr,  21,  0  },
   ...
   public:
      ...
      static constexpr PcrInfo  info[] = {
            ...
            // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
            /* ADC0_DP0        = PTE20 (p9)                     */  { PORTE_CLOCK_MASK, PORTE_BasePtr,  GPIOE_BasePtr,  20,  0  },
            /* ADC0_DP1        = PTE16 (p8)                     */  { PORTE_CLOCK_MASK, PORTE_BasePtr,  GPIOE_BasePtr,  16,  0  },
   ...
   public:
      ...
      static constexpr PcrInfo  info[] = {
            ...
            // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
            /* ADC0_DM0        = PTE21 (p10)                    */  { PORTE_CLOCK_MASK, PORTE_BasePtr,  GPIOE_BasePtr,  21,  0  },
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
         /* I2C1_SCL        = PTD7 (p64)                     */  { PORTD_CLOCK_MASK, PORTD_BasePtr,  GPIOD_BasePtr,  7,   4  },
         /* I2C1_SDA        = PTD6 (p63)                     */  { PORTD_CLOCK_MASK, PORTD_BasePtr,  GPIOD_BasePtr,  6,   4  },
   };
};
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         /* LLWU_P8         = PTC4 (p49)                     */  { PORTC_CLOCK_MASK, PORTC_BasePtr,  GPIOC_BasePtr,  4,   1  },
         /* LLWU_P9         = PTC5 (p50)                     */  { PORTC_CLOCK_MASK, PORTC_BasePtr,  GPIOC_BasePtr,  5,   1  },
         /* LLWU_P10        = PTC6 (p51)                     */  { PORTC_CLOCK_MASK, PORTC_BasePtr,  GPIOC_BasePtr,  6,   1  },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
         /* TPM0_CH0        = PTE24 (p20)                    */  { PORTE_CLOCK_MASK, PORTE_BasePtr,  GPIOE_BasePtr,  24,  3  },
         /* TPM0_CH1        = PTE25 (p21)                    */  { PORTE_CLOCK_MASK, PORTE_BasePtr,  GPIOE_BasePtr,  25,  3  },
         /* TPM0_CH2        = PTA5 (p27)                     */  { PORTA_CLOCK_MASK, PORTA_BasePtr,  GPIOA_BasePtr,  5,   3  },
         /* TPM0_CH3        = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* TPM0_CH4        = PTE31 (p19)                    */  { PORTE_CLOCK_MASK, PORTE_BasePtr,  GPIOE_BasePtr,  31,  3  },
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
         /* TPM2_CH0        = PTA1 (p23)                     */  { PORTA_CLOCK_MASK, PORTA_BasePtr,  GPIOA_BasePtr,  1,   3  },
         /* TPM2_CH1        = PTA2 (p24)                     */  { PORTA_CLOCK_MASK, PORTA_BasePtr,  GPIOA_BasePtr,  2,   3  },
   };
};
...
using adc_p8               = const USBDM::Adc0<1>;
using adc_p9               = const USBDM::Adc0<0>;
using adc_p10              = const USBDM::Adc0<36>;
/** 
 * End ADC_Group
 * @}
 */
...
using tpm_p27              = const USBDM::Tpm0<2>;
using tpm_p20              = const USBDM::Tpm0<0>;
using tpm_p21              = const USBDM::Tpm0<1>;
using tpm_p19              = const USBDM::Tpm0<4>;
/**
 * Convenience template class representing a TPM
 *
 * Example
...
using tpm_p23              = const USBDM::Tpm2<0>;
using tpm_p24              = const USBDM::Tpm2<1>;
/** 
 * End TPM_Group
 * @}
 */
 ...
 *  PTC2                     | ADC0_SE11                                   | p45                 | -       
 *  PTC3                     | Disabled                                    | p46                 | -       
 *  PTC4                     | GPIOC_4/LLWU_P8                             | p49                 | -       
 *  PTC5                     | GPIOC_5/LLWU_P9                             | p50                 | -       
 *  PTC6                     | GPIOC_6/LLWU_P10                            | p51                 | -       
 *  PTC7                     | GPIOC_7                                     | p52                 | -       
 *  PTC8                     | GPIOC_8                                     | p53                 | -       
 *  PTC9                     | GPIOC_9                                     | p54                 | -       
 *  PTC10                    | Disabled                                    | p55                 | -       
 ...
 *  PTE0                     | Disabled                                    | p1                  | -       
 *  PTE1                     | Disabled                                    | p2                  | -       
 *  PTE16                    | ADC0_DP1/ADC0_SE1                           | p8                  | -       
 *  PTE20                    | ADC0_DP0/ADC0_SE0                           | p9                  | -       
 *  PTE21                    | ADC0_DM0/ADC0_SE4a                          | p10                 | -       
 *  PTE22                    | ADC0_DP3/ADC0_SE3                           | p11                 | -       
 *  PTE23                    | ADC0_DM3/ADC0_SE7a                          | p12                 | -       
 *  PTE24                    | TPM0_CH0                                    | p20                 | -       
 *  PTE25                    | TPM0_CH1                                    | p21                 | -       
 *  PTE29                    | CMP0_IN5/ADC0_SE4b                          | p17                 | -       
 *  PTE30                    | ADC0_SE23/CMP0_IN4                          | p18                 | -       
 *  PTE31                    | TPM0_CH4                                    | p19                 | -       
 *  USB0_DM                  | USB0_DM                                     | p6                  | -       
 *  USB0_DP                  | USB0_DP                                     | p5                  | -       
 *  USB_VDD                  | USB_VDD                                     | p7                  | -       
