 ...
 * @version   1.2.0
 * @brief     Pin declarations for MK22FN512VDC12
 *
 * *****************************
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         /* ADC0_SE0        = ADC0_DP0 (K1)                  */  { 0, 0, 0, FIXED_NO_PCR, 0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* ADC0_SE3        = ADC1_DP0 (L1)                  */  { 0, 0, 0, FIXED_NO_PCR, 0 },
         /* ADC0_SE4b       = PTC2 (C8)                      */  { PORTC_CLOCK_MASK, PORTC_BasePtr,  GPIOC_BasePtr,  2,   0  },
         /* ADC0_SE5b       = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* ADC0_SE6b       = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* ADC0_SE7b       = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* ADC0_SE8        = PTB0 (G11)                     */  { PORTB_CLOCK_MASK, PORTB_BasePtr,  GPIOB_BasePtr,  0,   0  },
         /* ADC0_SE9        = PTB1 (G10)                     */  { PORTB_CLOCK_MASK, PORTB_BasePtr,  GPIOB_BasePtr,  1,   0  },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* ADC0_SE12       = PTB2 (G9)                      */  { PORTB_CLOCK_MASK, PORTB_BasePtr,  GPIOB_BasePtr,  2,   0  },
         /* ADC0_SE13       = PTB3 (G8)                      */  { PORTB_CLOCK_MASK, PORTB_BasePtr,  GPIOB_BasePtr,  3,   0  },
         /* ADC0_SE14       = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* ADC0_SE15       = PTC1 (D8)                      */  { PORTC_CLOCK_MASK, PORTC_BasePtr,  GPIOC_BasePtr,  1,   0  },
         /* ADC0_SE16       = ADC0_SE16 (H3)                 */  { 0, 0, 0, FIXED_NO_PCR, 0 },
         /* ADC0_SE17       = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* ADC0_SE18       = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* ADC0_SE19       = ADC0_DM0 (K2)                  */  { 0, 0, 0, FIXED_NO_PCR, 0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
   ...
   public:
      ...
      static constexpr PcrInfo  info[] = {
            ...
            /* ADC0_DP2        = ADC1_DP1 (J1)                  */  { 0, 0, 0, FIXED_NO_PCR, 0 },
   ...
   public:
      ...
      static constexpr PcrInfo  info[] = {
            ...
            /* ADC0_DM2        = ADC1_DM1 (J2)                  */  { 0, 0, 0, FIXED_NO_PCR, 0 },
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
         /* ADC1_SE0        = ADC1_DP0 (L1)                  */  { 0, 0, 0, FIXED_NO_PCR, 0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         ...
         /* ADC1_SE8        = PTB0 (G11)                     */  { PORTB_CLOCK_MASK, PORTB_BasePtr,  GPIOB_BasePtr,  0,   0  },
         /* ADC1_SE9        = PTB1 (G10)                     */  { PORTB_CLOCK_MASK, PORTB_BasePtr,  GPIOB_BasePtr,  1,   0  },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         ...
         /* ADC1_SE19       = ADC1_DM0 (L2)                  */  { 0, 0, 0, FIXED_NO_PCR, 0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
         /* CMP1_IN0        = PTC2 (C8)                      */  { PORTC_CLOCK_MASK, PORTC_BasePtr,  GPIOC_BasePtr,  2,   0  },
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         /* FTM0_CH1        = PTA4 (J8)                      */  { PORTA_CLOCK_MASK, PORTA_BasePtr,  GPIOA_BasePtr,  4,   3  },
         /* FTM0_CH2        = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* FTM0_CH3        = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* FTM0_CH4        = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* FTM0_CH5        = PTD5 (A2)                      */  { PORTD_CLOCK_MASK, PORTD_BasePtr,  GPIOD_BasePtr,  5,   4  },
         /* FTM0_CH6        = PTA1 (H8)                      */  { PORTA_CLOCK_MASK, PORTA_BasePtr,  GPIOA_BasePtr,  1,   3  },
         /* FTM0_CH7        = PTA2 (J7)                      */  { PORTA_CLOCK_MASK, PORTA_BasePtr,  GPIOA_BasePtr,  2,   3  },
   };
   class InfoFAULT {
   public:
      //! Information for each signal of peripheral
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
         /* I2C1_SCL        = PTE1 (E3)                      */  { PORTE_CLOCK_MASK, PORTE_BasePtr,  GPIOE_BasePtr,  1,   6  },
         /* I2C1_SDA        = PTE0 (E4)                      */  { PORTE_CLOCK_MASK, PORTE_BasePtr,  GPIOE_BasePtr,  0,   6  },
   };
};
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         /* LLWU_P7         = PTC3 (B8)                      */  { PORTC_CLOCK_MASK, PORTC_BasePtr,  GPIOC_BasePtr,  3,   1  },
         /* LLWU_P8         = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* LLWU_P9         = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* LLWU_P10        = PTC6 (C7)                      */  { PORTC_CLOCK_MASK, PORTC_BasePtr,  GPIOC_BasePtr,  6,   1  },
         /* LLWU_P11        = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* LLWU_P12        = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* LLWU_P13        = PTD2 (C3)                      */  { PORTD_CLOCK_MASK, PORTD_BasePtr,  GPIOD_BasePtr,  2,   1  },
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         /* SPI1_SIN        = PTD7 (A1)                      */  { PORTD_CLOCK_MASK, PORTD_BasePtr,  GPIOD_BasePtr,  7,   7  },
...
using adc_K2               = const USBDM::Adc0<19>;
using adc_K1               = const USBDM::Adc0<0>;
using adc_H3               = const USBDM::Adc0<16>;
//using adc_H3               = const USBDM::Adc0<21>;
using adc_L1               = const USBDM::Adc0<3>;
using adc_J3               = const USBDM::Adc0<22>;
using adc_K5               = const USBDM::Adc0<23>;
using adc_G11              = const USBDM::Adc0<8>;
using adc_G10              = const USBDM::Adc0<9>;
using adc_G9               = const USBDM::Adc0<12>;
using adc_G8               = const USBDM::Adc0<13>;
using adc_D8               = const USBDM::Adc0<15>;
using adc_C8               = const USBDM::Adc0<4>;
/**
 * Convenience templated class representing an ADC
 *
 * Example
...
using adc_L2               = const USBDM::Adc1<19>;
//using adc_L1               = const USBDM::Adc1<0>;
//using adc_J3               = const USBDM::Adc1<16>;
using adc_K4               = const USBDM::Adc1<23>;
//using adc_G11              = const USBDM::Adc1<8>;
//using adc_G10              = const USBDM::Adc1<9>;
...
using ftm_H8               = const USBDM::Ftm0<6>;
using ftm_J7               = const USBDM::Ftm0<7>;
using ftm_J8               = const USBDM::Ftm0<1>;
using ftm_A2               = const USBDM::Ftm0<5>;
/**
 * Convenience template class representing a FTM
 *
 * Example
...
using gpio_K7              = const USBDM::GpioA<5>;
/**
...
using gpio_B10             = const USBDM::GpioB<16>;
using gpio_D9              = const USBDM::GpioB<18>;
using gpio_C9              = const USBDM::GpioB<19>;
/**
...
using gpio_B8              = const USBDM::GpioC<3>;
using gpio_C7              = const USBDM::GpioC<6>;
/**
...
using gpio_C3              = const USBDM::GpioD<2>;
 ...
 *  ------------------------ | --------------------------------------------|---------------------| ------------- 
 *  ADC0_DM0                 | ADC0_DM0/ADC1_DM3/ADC0_SE19                 | K2                  | -       
 *  ADC0_DM1                 | ADC0_DM1                                    | H2                  | -       
 *  ADC0_DP0                 | ADC0_DP0/ADC1_DP3/ADC0_SE0                  | K1                  | -       
 *  ADC0_DP1                 | ADC0_DP1                                    | H1                  | -       
 *  ADC0_SE16                | ADC0_SE16/CMP1_IN2/ADC0_SE21                | H3                  | -       
 *  ADC1_DM0                 | ADC1_DM0/ADC0_DM3/ADC1_SE19                 | L2                  | -       
 *  ADC1_DM1                 | ADC1_DM1/ADC0_DM2                           | J2                  | -       
 *  ADC1_DP0                 | ADC1_DP0/ADC0_DP3/ADC1_SE0/ADC0_SE3         | L1                  | -       
 *  ADC1_DP1                 | ADC1_DP1/ADC0_DP2                           | J1                  | -       
 *  ADC1_SE16                | ADC1_SE16/ADC0_SE22                         | J3                  | -       
 *  DAC0_OUT                 | DAC0_OUT/CMP1_IN3/ADC0_SE23                 | K5                  | -       
 *  DAC1_OUT                 | DAC1_OUT/CMP0_IN4/ADC1_SE23                 | K4                  | -       
 *  EXTAL32                  | EXTAL32                                     | L5                  | -       
 ...
 *  PTC3                     | GPIOC_3/LLWU_P7                             | B8                  | -       
 *  PTC4                     | Disabled                                    | A8                  | -       
 *  PTC5                     | Disabled                                    | D7                  | -       
 *  PTC6                     | GPIOC_6/LLWU_P10                            | C7                  | -       
 *  PTC7                     | CMP0_IN1                                    | B7                  | -       
