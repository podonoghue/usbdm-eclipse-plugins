...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         /* ADC0_SE0        = ADC0_DP0 (J24_1)               */  { 0, 0, 0, FIXED_NO_PCR, 0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* ADC0_SE3        = ADC1_DP0 (J24_5)               */  { 0, 0, 0, FIXED_NO_PCR, 0 },
         /* ADC0_SE4b       = PTC2 (A3/J24_8)                */  { PORTC_CLOCK_MASK, PORTC_BasePtr,  GPIOC_BasePtr,  2,   0  },
         /* ADC0_SE5b       = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* ADC0_SE6b       = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* ADC0_SE7b       = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* ADC0_SE8        = PTB0 (A0/J24_2)                */  { PORTB_CLOCK_MASK, PORTB_BasePtr,  GPIOB_BasePtr,  0,   0  },
         /* ADC0_SE9        = PTB1 (A1/J24_4)                */  { PORTB_CLOCK_MASK, PORTB_BasePtr,  GPIOB_BasePtr,  1,   0  },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* ADC0_SE12       = PTB2 (A5/J24_12/ONBOARD_SCL)   */  { PORTB_CLOCK_MASK, PORTB_BasePtr,  GPIOB_BasePtr,  2,   0  },
         /* ADC0_SE13       = PTB3 (A4/J24_10/ONBOARD_SDA)   */  { PORTB_CLOCK_MASK, PORTB_BasePtr,  GPIOB_BasePtr,  3,   0  },
         /* ADC0_SE14       = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* ADC0_SE15       = PTC1 (A2/J24_6)                */  { PORTC_CLOCK_MASK, PORTC_BasePtr,  GPIOC_BasePtr,  1,   0  },
         /* ADC0_SE16       = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* ADC0_SE17       = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* ADC0_SE18       = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* ADC0_SE19       = ADC0_DM0 (J24_3)               */  { 0, 0, 0, FIXED_NO_PCR, 0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* ADC0_SE21       = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* ADC0_SE22       = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* ADC0_SE23       = DAC0_OUT (J24_11)              */  { 0, 0, 0, FIXED_NO_PCR, 0 },
   };
   class InfoDP {
   public:
      //! Information for each signal of peripheral
      static constexpr PcrInfo  info[] = {
            ...
            // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
            /* ADC0_DP0        = ADC0_DP0 (J24_1)               */  { 0, 0, 0, FIXED_NO_PCR, 0 },
            /* ADC0_DP1        = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
            /* ADC0_DP2        = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
            /* ADC0_DP3        = ADC1_DP0 (J24_5)               */  { 0, 0, 0, FIXED_NO_PCR, 0 },
      };
   }; 
   class InfoDM {
   public:
      ...
      static constexpr PcrInfo  info[] = {
            ...
            // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
            /* ADC0_DM0        = ADC0_DM0 (J24_3)               */  { 0, 0, 0, FIXED_NO_PCR, 0 },
            /* ADC0_DM1        = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
            /* ADC0_DM2        = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
            /* ADC0_DM3        = ADC1_DM0 (J24_7)               */  { 0, 0, 0, FIXED_NO_PCR, 0 },
      };
   }; 
};
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
         /* ADC1_SE0        = ADC1_DP0 (J24_5)               */  { 0, 0, 0, FIXED_NO_PCR, 0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         ...
         /* ADC1_SE8        = PTB0 (A0/J24_2)                */  { PORTB_CLOCK_MASK, PORTB_BasePtr,  GPIOB_BasePtr,  0,   0  },
         /* ADC1_SE9        = PTB1 (A1/J24_4)                */  { PORTB_CLOCK_MASK, PORTB_BasePtr,  GPIOB_BasePtr,  1,   0  },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         ...
         /* ADC1_SE19       = ADC1_DM0 (J24_7)               */  { 0, 0, 0, FIXED_NO_PCR, 0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
   ...
   public:
      ...
      static constexpr PcrInfo  info[] = {
            ...
            // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
            /* ADC1_DP0        = ADC1_DP0 (J24_5)               */  { 0, 0, 0, FIXED_NO_PCR, 0 },
            /* ADC1_DP1        = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
            /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
            /* ADC1_DP3        = ADC0_DP0 (J24_1)               */  { 0, 0, 0, FIXED_NO_PCR, 0 },
      };
   }; 
   class InfoDM {
   public:
      ...
      static constexpr PcrInfo  info[] = {
            ...
            // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
            /* ADC1_DM0        = ADC1_DM0 (J24_7)               */  { 0, 0, 0, FIXED_NO_PCR, 0 },
            /* ADC1_DM1        = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
            /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
            /* ADC1_DM3        = ADC0_DM0 (J24_3)               */  { 0, 0, 0, FIXED_NO_PCR, 0 },
      };
   }; 
};
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
         /* CMP1_IN0        = PTC2 (A3/J24_8)                */  { PORTC_CLOCK_MASK, PORTC_BasePtr,  GPIOC_BasePtr,  2,   0  },
         /* CMP1_IN1        = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* CMP1_IN2        = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* CMP1_IN3        = DAC0_OUT (J24_11)              */  { 0, 0, 0, FIXED_NO_PCR, 0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         /* FTM0_CH1        = PTA4 (D4/J1_10)                */  { PORTA_CLOCK_MASK, PORTA_BasePtr,  GPIOA_BasePtr,  4,   3  },
         /* FTM0_CH2        = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* FTM0_CH3        = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* FTM0_CH4        = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* FTM0_CH5        = PTD5 (D13/J2_12/LED_BLUE)      */  { PORTD_CLOCK_MASK, PORTD_BasePtr,  GPIOD_BasePtr,  5,   4  },
         /* FTM0_CH6        = PTA1 (D9/J2_4/LED_RED)         */  { PORTA_CLOCK_MASK, PORTA_BasePtr,  GPIOA_BasePtr,  1,   3  },
         /* FTM0_CH7        = PTA2 (D3/J1_8/LED_GREEN)       */  { PORTA_CLOCK_MASK, PORTA_BasePtr,  GPIOA_BasePtr,  2,   3  },
   };
   class InfoFAULT {
   public:
      //! Information for each signal of peripheral
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
         /* I2C1_SCL        = PTE1 (D15/J2_19/ConRx)         */  { PORTE_CLOCK_MASK, PORTE_BasePtr,  GPIOE_BasePtr,  1,   6  },
         /* I2C1_SDA        = PTE0 (D14/J2_18/ConTx)         */  { PORTE_CLOCK_MASK, PORTE_BasePtr,  GPIOE_BasePtr,  0,   6  },
   };
};
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         /* LLWU_P7         = PTC3 (D6/J1_14)                */  { PORTC_CLOCK_MASK, PORTC_BasePtr,  GPIOC_BasePtr,  3,   1  },
         /* LLWU_P8         = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* LLWU_P9         = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* LLWU_P10        = PTC6 (D7/J1_16)                */  { PORTC_CLOCK_MASK, PORTC_BasePtr,  GPIOC_BasePtr,  6,   1  },
         /* LLWU_P11        = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* LLWU_P12        = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* LLWU_P13        = PTD2 (D0/J1_2)                 */  { PORTD_CLOCK_MASK, PORTD_BasePtr,  GPIOD_BasePtr,  2,   1  },
         /* LLWU_P14        = PTD4 (D10/J2_6)                */  { PORTD_CLOCK_MASK, PORTD_BasePtr,  GPIOD_BasePtr,  4,   1  },
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         /* SPI1_SIN        = PTD7 (D12/J2_10)               */  { PORTD_CLOCK_MASK, PORTD_BasePtr,  GPIOD_BasePtr,  7,   7  },
         /* SPI1_SOUT       = PTD6 (D11/J2_8)                */  { PORTD_CLOCK_MASK, PORTD_BasePtr,  GPIOD_BasePtr,  6,   7  },
 ...
 *  ------------------------ | --------------------------------------------|---------------------| ------------- 
 *  ADC0_DM0                 | ADC0_DM0/ADC1_DM3/ADC0_SE19                 | J24_3               | -       
 *  ADC0_DP0                 | ADC0_DP0/ADC1_DP3/ADC0_SE0                  | J24_1               | -       
 *  ADC1_DM0                 | ADC1_DM0/ADC0_DM3/ADC1_SE19                 | J24_7               | -       
 *  ADC1_DP0                 | ADC1_DP0/ADC0_DP3/ADC1_SE0/ADC0_SE3         | J24_5               | -       
 *  DAC0_OUT                 | DAC0_OUT/CMP1_IN3/ADC0_SE23                 | J24_11              | -       
 *  EXTAL32                  | EXTAL32                                     | EXTAL32             | -       
 *  PTA0                     | JTAG_TCLK/SWD_CLK                           | SWD_CLK             | -       
 *  PTA1                     | FTM0_CH6                                    | D9/J2_4/LED_RED     | -       
 *  PTA2                     | FTM0_CH7                                    | D3/J1_8/LED_GREEN     | -       
 *  PTA3                     | JTAG_TMS/SWD_DIO                            | SWD_DIO             | -       
 *  PTA4                     | FTM0_CH1                                    | D4/J1_10            | -       
 *  PTA5                     | GPIOA_5                                     | J1_1                | -       
 *  PTA12                    | Disabled                                    | J1_5                | -       
 *  PTA13                    | Disabled                                    | J1_3                | -       
 *  PTA18                    | EXTAL0                                      | EXTAL0              | -       
 ...
 *  PTB2                     | ADC0_SE12                                   | A5/J24_12/ONBOARD_SCL     | -       
 *  PTB3                     | ADC0_SE13                                   | A4/J24_10/ONBOARD_SDA     | -       
 *  PTB16                    | GPIOB_16                                    | D2/J1_6             | -       
 *  PTB17                    | Disabled                                    |                     | -       
 *  PTB18                    | GPIOB_18                                    | D5/J1_12            | -       
 *  PTB19                    | GPIOB_19                                    | D8/J2_2             | -       
 *  PTC0                     | ADC0_SE14                                   |                     | -       
 *  PTC1                     | ADC0_SE15                                   | A2/J24_6            | -       
 *  PTC2                     | ADC0_SE4b/CMP1_IN0                          | A3/J24_8            | -       
 *  PTC3                     | GPIOC_3/LLWU_P7                             | D6/J1_14            | -       
 *  PTC4                     | Disabled                                    | J24_9               | -       
 *  PTC5                     | Disabled                                    | J1_15               | -       
 *  PTC6                     | GPIOC_6/LLWU_P10                            | D7/J1_16            | -       
 *  PTC7                     | CMP0_IN1                                    | J1_11               | -       
 *  PTC8                     | ADC1_SE4b/CMP0_IN2                          | J1_7                | -       
 *  PTC9                     | ADC1_SE5b/CMP0_IN3                          | J1_9                | -       
 *  PTC10                    | ADC1_SE6b                                   | J1_13               | -       
 *  PTC11                    | ADC1_SE7b                                   |                     | -       
 *  PTD0                     | Disabled                                    |                     | -       
 *  PTD1                     | ADC0_SE5b                                   |                     | -       
 *  PTD2                     | GPIOD_2/LLWU_P13                            | D0/J1_2             | -       
 *  PTD3                     | GPIOD_3                                     | D1/J1_4             | -       
 *  PTD4                     | GPIOD_4/LLWU_P14                            | D10/J2_6            | -       
 *  PTD5                     | FTM0_CH5                                    | D13/J2_12/LED_BLUE     | -       
 *  PTD6                     | SPI1_SOUT                                   | D11/J2_8            | -       
 *  PTD7                     | SPI1_SIN                                    | D12/J2_10           | -       
 *  PTE0                     | I2C1_SDA                                    | D14/J2_18/ConTx     | -       
 *  PTE1                     | I2C1_SCL                                    | D15/J2_19/ConRx     | -       
