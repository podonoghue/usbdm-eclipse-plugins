...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         /* ADC0_SE0        = ADC0_DP0 (9)                   */  { 0, 0, 0, FIXED_NO_PCR, 0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* ADC0_SE3        = ADC1_DP0 (11)                  */  { 0, 0, 0, FIXED_NO_PCR, 0 },
         /* ADC0_SE4b       = PTC2 (45)                      */  { PORTC_CLOCK_MASK, PORTC_BasePtr,  GPIOC_BasePtr,  2,   0  },
         /* ADC0_SE5b       = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* ADC0_SE6b       = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* ADC0_SE7b       = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* ADC0_SE8        = PTB0 (35)                      */  { PORTB_CLOCK_MASK, PORTB_BasePtr,  GPIOB_BasePtr,  0,   0  },
         /* ADC0_SE9        = PTB1 (36)                      */  { PORTB_CLOCK_MASK, PORTB_BasePtr,  GPIOB_BasePtr,  1,   0  },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* ADC0_SE12       = PTB2 (37)                      */  { PORTB_CLOCK_MASK, PORTB_BasePtr,  GPIOB_BasePtr,  2,   0  },
         /* ADC0_SE13       = PTB3 (38)                      */  { PORTB_CLOCK_MASK, PORTB_BasePtr,  GPIOB_BasePtr,  3,   0  },
         /* ADC0_SE14       = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* ADC0_SE15       = PTC1 (44)                      */  { PORTC_CLOCK_MASK, PORTC_BasePtr,  GPIOC_BasePtr,  1,   0  },
         /* ADC0_SE16       = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* ADC0_SE17       = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* ADC0_SE18       = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* ADC0_SE19       = ADC0_DM0 (10)                  */  { 0, 0, 0, FIXED_NO_PCR, 0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* ADC0_SE21       = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* ADC0_SE22       = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* ADC0_SE23       = DAC0_OUT (18)                  */  { 0, 0, 0, FIXED_NO_PCR, 0 },
   };
   class InfoDP {
   public:
      //! Information for each signal of peripheral
      static constexpr PcrInfo  info[] = {
            ...
            // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
            /* ADC0_DP0        = ADC0_DP0 (9)                   */  { 0, 0, 0, FIXED_NO_PCR, 0 },
            /* ADC0_DP1        = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
            /* ADC0_DP2        = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
            /* ADC0_DP3        = ADC1_DP0 (11)                  */  { 0, 0, 0, FIXED_NO_PCR, 0 },
      };
   }; 
   class InfoDM {
   public:
      ...
      static constexpr PcrInfo  info[] = {
            ...
            // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
            /* ADC0_DM0        = ADC0_DM0 (10)                  */  { 0, 0, 0, FIXED_NO_PCR, 0 },
            /* ADC0_DM1        = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
            /* ADC0_DM2        = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
            /* ADC0_DM3        = ADC1_DM0 (12)                  */  { 0, 0, 0, FIXED_NO_PCR, 0 },
      };
   }; 
};
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
         /* ADC1_SE0        = ADC1_DP0 (11)                  */  { 0, 0, 0, FIXED_NO_PCR, 0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         ...
         /* ADC1_SE8        = PTB0 (35)                      */  { PORTB_CLOCK_MASK, PORTB_BasePtr,  GPIOB_BasePtr,  0,   0  },
         /* ADC1_SE9        = PTB1 (36)                      */  { PORTB_CLOCK_MASK, PORTB_BasePtr,  GPIOB_BasePtr,  1,   0  },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         ...
         /* ADC1_SE18       = VREF_OUT (17)                  */  { 0, 0, 0, FIXED_NO_PCR, 0 },
         /* ADC1_SE19       = ADC1_DM0 (12)                  */  { 0, 0, 0, FIXED_NO_PCR, 0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
   ...
   public:
      ...
      static constexpr PcrInfo  info[] = {
            ...
            // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
            /* ADC1_DP0        = ADC1_DP0 (11)                  */  { 0, 0, 0, FIXED_NO_PCR, 0 },
            /* ADC1_DP1        = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
            /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
            /* ADC1_DP3        = ADC0_DP0 (9)                   */  { 0, 0, 0, FIXED_NO_PCR, 0 },
      };
   }; 
   class InfoDM {
   public:
      ...
      static constexpr PcrInfo  info[] = {
            ...
            // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
            /* ADC1_DM0        = ADC1_DM0 (12)                  */  { 0, 0, 0, FIXED_NO_PCR, 0 },
            /* ADC1_DM1        = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
            /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
            /* ADC1_DM3        = ADC0_DM0 (10)                  */  { 0, 0, 0, FIXED_NO_PCR, 0 },
      };
   }; 
};
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         /* CMP0_IN5        = VREF_OUT (17)                  */  { 0, 0, 0, FIXED_NO_PCR, 0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
         /* CMP1_IN0        = PTC2 (45)                      */  { PORTC_CLOCK_MASK, PORTC_BasePtr,  GPIOC_BasePtr,  2,   0  },
         /* CMP1_IN1        = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* CMP1_IN2        = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* CMP1_IN3        = DAC0_OUT (18)                  */  { 0, 0, 0, FIXED_NO_PCR, 0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* CMP1_IN5        = VREF_OUT (17)                  */  { 0, 0, 0, FIXED_NO_PCR, 0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
         /* --              = --                             */  { 0, 0, 0, INVALID_PCR,  0 },
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         /* FTM0_CH1        = PTA4 (26)                      */  { PORTA_CLOCK_MASK, PORTA_BasePtr,  GPIOA_BasePtr,  4,   3  },
         /* FTM0_CH2        = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* FTM0_CH3        = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* FTM0_CH4        = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* FTM0_CH5        = PTD5 (62)                      */  { PORTD_CLOCK_MASK, PORTD_BasePtr,  GPIOD_BasePtr,  5,   4  },
         /* FTM0_CH6        = PTA1 (23)                      */  { PORTA_CLOCK_MASK, PORTA_BasePtr,  GPIOA_BasePtr,  1,   3  },
         /* FTM0_CH7        = PTA2 (24)                      */  { PORTA_CLOCK_MASK, PORTA_BasePtr,  GPIOA_BasePtr,  2,   3  },
   };
   class InfoFAULT {
   public:
      //! Information for each signal of peripheral
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         /* LLWU_P7         = PTC3 (46)                      */  { PORTC_CLOCK_MASK, PORTC_BasePtr,  GPIOC_BasePtr,  3,   1  },
         /* LLWU_P8         = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* LLWU_P9         = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* LLWU_P10        = PTC6 (51)                      */  { PORTC_CLOCK_MASK, PORTC_BasePtr,  GPIOC_BasePtr,  6,   1  },
         /* LLWU_P11        = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* LLWU_P12        = --                             */  { 0, 0, 0, UNMAPPED_PCR, 0 },
         /* LLWU_P13        = PTD2 (59)                      */  { PORTD_CLOCK_MASK, PORTD_BasePtr,  GPIOD_BasePtr,  2,   1  },
         /* LLWU_P14        = PTD4 (61)                      */  { PORTD_CLOCK_MASK, PORTD_BasePtr,  GPIOD_BasePtr,  4,   1  },
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         /* SPI1_SIN        = PTD7 (64)                      */  { PORTD_CLOCK_MASK, PORTD_BasePtr,  GPIOD_BasePtr,  7,   7  },
         /* SPI1_SOUT       = PTD6 (63)                      */  { PORTD_CLOCK_MASK, PORTD_BasePtr,  GPIOD_BasePtr,  6,   7  },
...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         // Signal            Pin                                 clockMask          pcrAddress      gpioAddress     bit  mux
         /* VREF_OUT        = VREF_OUT (17)                  */  { 0, 0, 0, FIXED_NO_PCR, 0 },
   };
};
...
using adc_10               = const USBDM::Adc0<19>;
using adc_9                = const USBDM::Adc0<0>;
using adc_11               = const USBDM::Adc0<3>;
using adc_18               = const USBDM::Adc0<23>;
using adc_35               = const USBDM::Adc0<8>;
using adc_36               = const USBDM::Adc0<9>;
using adc_37               = const USBDM::Adc0<12>;
using adc_38               = const USBDM::Adc0<13>;
using adc_44               = const USBDM::Adc0<15>;
using adc_45               = const USBDM::Adc0<4>;
/**
 * Convenience templated class representing an ADC
 *
 * Example
...
using adc_12               = const USBDM::Adc1<19>;
//using adc_11               = const USBDM::Adc1<0>;
//using adc_35               = const USBDM::Adc1<8>;
//using adc_36               = const USBDM::Adc1<9>;
using adc_17               = const USBDM::Adc1<18>;
/** 
 * End ADC_Group
 * @}
 */
...
using ftm_23               = const USBDM::Ftm0<6>;
using ftm_24               = const USBDM::Ftm0<7>;
using ftm_26               = const USBDM::Ftm0<1>;
using ftm_62               = const USBDM::Ftm0<5>;
/**
 * Convenience template class representing a FTM
 *
 * Example
...
using gpio_27              = const USBDM::GpioA<5>;
/**
...
using gpio_39              = const USBDM::GpioB<16>;
using gpio_41              = const USBDM::GpioB<18>;
using gpio_42              = const USBDM::GpioB<19>;
/**
...
using gpio_46              = const USBDM::GpioC<3>;
using gpio_51              = const USBDM::GpioC<6>;
/**
...
using gpio_59              = const USBDM::GpioD<2>;
using gpio_60              = const USBDM::GpioD<3>;
using gpio_61              = const USBDM::GpioD<4>;
/**
 ...
 *  ------------------------ | --------------------------------------------|---------------------| ------------- 
 *  ADC0_DM0                 | ADC0_DM0/ADC1_DM3/ADC0_SE19                 | 10                  | -       
 *  ADC0_DP0                 | ADC0_DP0/ADC1_DP3/ADC0_SE0                  | 9                   | -       
 *  ADC1_DM0                 | ADC1_DM0/ADC0_DM3/ADC1_SE19                 | 12                  | -       
 *  ADC1_DP0                 | ADC1_DP0/ADC0_DP3/ADC1_SE0/ADC0_SE3         | 11                  | -       
 *  DAC0_OUT                 | DAC0_OUT/CMP1_IN3/ADC0_SE23                 | 18                  | -       
 *  EXTAL32                  | EXTAL32                                     | 20                  | -       
 *  PTA0                     | JTAG_TCLK/SWD_CLK                           | 22                  | -       
 *  PTA1                     | FTM0_CH6                                    | 23                  | -       
 *  PTA2                     | FTM0_CH7                                    | 24                  | -       
 *  PTA3                     | JTAG_TMS/SWD_DIO                            | 25                  | -       
 *  PTA4                     | FTM0_CH1                                    | 26                  | -       
 *  PTA5                     | GPIOA_5                                     | 27                  | -       
 *  PTA12                    | Disabled                                    | 28                  | -       
 *  PTA13                    | Disabled                                    | 29                  | -       
 *  PTA18                    | EXTAL0                                      | 32                  | -       
 *  PTA19                    | XTAL0                                       | 33                  | -       
 *  PTB0                     | ADC0_SE8/ADC1_SE8                           | 35                  | -       
 *  PTB1                     | ADC0_SE9/ADC1_SE9                           | 36                  | -       
 *  PTB2                     | ADC0_SE12                                   | 37                  | -       
 *  PTB3                     | ADC0_SE13                                   | 38                  | -       
 *  PTB16                    | GPIOB_16                                    | 39                  | -       
 *  PTB17                    | Disabled                                    | 40                  | -       
 ...
 *  PTC0                     | ADC0_SE14                                   | 43                  | -       
 *  PTC1                     | ADC0_SE15                                   | 44                  | -       
 *  PTC2                     | ADC0_SE4b/CMP1_IN0                          | 45                  | -       
 *  PTC3                     | GPIOC_3/LLWU_P7                             | 46                  | -       
 *  PTC4                     | Disabled                                    | 49                  | -       
 *  PTC5                     | Disabled                                    | 50                  | -       
 *  PTC6                     | GPIOC_6/LLWU_P10                            | 51                  | -       
 *  PTC7                     | CMP0_IN1                                    | 52                  | -       
 *  PTC8                     | ADC1_SE4b/CMP0_IN2                          | 53                  | -       
 *  PTC9                     | ADC1_SE5b/CMP0_IN3                          | 54                  | -       
 *  PTC10                    | ADC1_SE6b                                   | 55                  | -       
 *  PTC11                    | ADC1_SE7b                                   | 56                  | -       
 *  PTD0                     | Disabled                                    | 57                  | -       
 *  PTD1                     | ADC0_SE5b                                   | 58                  | -       
 *  PTD2                     | GPIOD_2/LLWU_P13                            | 59                  | -       
 *  PTD3                     | GPIOD_3                                     | 60                  | -       
 *  PTD4                     | GPIOD_4/LLWU_P14                            | 61                  | -       
 *  PTD5                     | FTM0_CH5                                    | 62                  | -       
 *  PTD6                     | SPI1_SOUT                                   | 63                  | -       
 *  PTD7                     | SPI1_SIN                                    | 64                  | -       
 *  PTE0                     | I2C1_SDA                                    | 1                   | -       
 ...
 *  VREFH                    | VREFH                                       | 14                  | -       
 *  VREFL                    | VREFL                                       | 15                  | -       
 *  VREF_OUT                 | VREF_OUT/CMP1_IN5/CMP0_IN5/ADC1_SE18        | 17                  | -       
 *  VREGIN                   | VREGIN                                      | 8                   | -       
 *  VSS1                     | VSS1                                        | 4                   | -       
 *  VSS3                     | VSS3                                        | 31                  | -       
 *  VSS5                     | VSS                                         | 47                  | -       
