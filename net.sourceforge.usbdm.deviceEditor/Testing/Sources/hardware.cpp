...
static constexpr PinInit pinInit[] = {
 ...
 /* PTC1       ==> GPIOC_1/LLWU_P6                */  { PORT_PCR_MUX(1)|USBDM::DEFAULT_PCR, &PORTC->PCR[1],  },
 /* PTC2       ==> ADC0_SE4b/CMP1_IN0/TSI0_CH15   */  { PORT_PCR_MUX(0)|USBDM::DEFAULT_PCR, &PORTC->PCR[2],  },
 /* PTC3       ==> CMP1_IN1                       */  { PORT_PCR_MUX(0)|USBDM::DEFAULT_PCR, &PORTC->PCR[3],  },
 /* PTC4       ==> CMP1_OUT                       */  { PORT_PCR_MUX(6)|USBDM::DEFAULT_PCR, &PORTC->PCR[4],  },
 ...
 /* PTE0       ==> RTC_CLKOUT                     */  { PORT_PCR_MUX(7)|USBDM::DEFAULT_PCR, &PORTE->PCR[0],  },
