...
public:
   ...
   /**
    * Gets input clock frequency of LPTMR
    *
    * @return Frequency as an uint32_t in Hz
    */
   static uint32_t getInputClockFrequency() {
      /** Pointer to hardware */
...
public:
   ...
   static constexpr uint32_t sopt7 = 
      ...
      SIM_SOPT7_ADC0PRETRGSEL(1) |   // ADC0 pretrigger select
      SIM_SOPT7_ADC0TRGSEL(7);       // ADC0 trigger select
