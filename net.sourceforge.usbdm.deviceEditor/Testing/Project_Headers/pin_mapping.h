...
public:
   ...
   static constexpr PcrInfo  info[] = {
         ...
         //      Signal                 Pin                                 clockMask          pcrAddress      gpioAddress     bit  PCR value
         /*   0: FTM0_CH0             = PTC1 (A1)                      */  { PORTC_CLOCK_MASK, PORTC_BasePtr,  GPIOC_BasePtr,  1,   PORT_PCR_MUX(4)|pcrValue  },
    ...
    */
   static void initPCRs() {
      PcrTable_T<Ftm0Info,  0>::setPCR(); // FTM0_CH0        = PTC1 (A1)                     
    ...
    */
   static void clearPCRs() {
      PcrTable_T<Ftm0Info,  0>::setPCR(0); // FTM0_CH0        = PTC1 (A1)                     
...
public:
   ...
   public:
      ...
      static constexpr PcrInfo  info[] = {
            ...
            /*   1: FTM1_QD_PHB          = PTA13 (D24)                    */  { PORTA_CLOCK_MASK, PORTA_BasePtr,  GPIOA_BasePtr,  13,  PORT_PCR_MUX(7)|pcrValue  },
      };
       ...
       */
      static void initPCRs() {
         PcrTable_T<Ftm1Info::InfoQUAD,  1>::setPCR(); // FTM1_QD_PHB     = PTA13 (D24)                   
      }
       ...
       */
      static void clearPCRs() {
         PcrTable_T<Ftm1Info::InfoQUAD,  1>::setPCR(0); // FTM1_QD_PHB     = PTA13 (D24)                   
      }
...
public:
   ...
   static constexpr uint32_t SIM_CLKDIV1 = 
      SIM_CLKDIV1_OUTDIV4(-1) | // SIM_CLKDIV1_OUTDIV4
