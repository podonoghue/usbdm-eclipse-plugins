...
public:
   ...
   static constexpr uint32_t ftmExternalClock =  100;
...
public:
   ...
   static constexpr uint32_t sopt4 = 
      ...
      SIM_SOPT4_FTM0FLT3(0)    |   // FlexTimer 0 Fault 3 Select
   ...
   static constexpr uint32_t sopt9 = 
      SIM_SOPT9_TPM2CLKSEL(0)  |   // TPM2 External Clock Pin Select
      SIM_SOPT9_TPM1CLKSEL(0)  |   // TPM1 External Clock Pin Select
      SIM_SOPT9_TPM2CH0SRC(0)  |   // TPM2 channel 0 input capture source select
      SIM_SOPT9_TPM1CH0SRC(0)  |   // TPM1 channel 0 input capture source select
   //! System Clock Divider Register 1
   static constexpr uint32_t clkdiv1 = 
      SIM_CLKDIV1_OUTDIV4(4)|  // Flash clock
      SIM_CLKDIV1_OUTDIV3(1)|  // FlexBus clock
   ...
   static constexpr uint32_t clkdiv3 = 
      6;  // PLLFLL clock divider divisor & fraction 
