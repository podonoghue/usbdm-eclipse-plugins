/**
 * @file      gpio.cpp (derived from gpio-MKL46Z4-LQFP100.cpp)
 * @version   1.2.0
...
#endif
#if (PTE19_SIG_SEL>=0)
   { PORT_PCR_MUX(PTE19_SIG_SEL)|USBDM::DEFAULT_PCR, &PORTE->PCR[19]},
#endif
#if (PTE20_SIG_SEL>=0)
...
void usbdm_PinMapping() {
   ...
   SIM->FIXED_PORT_CLOCK_REG |= PORTA_CLOCK_MASK;
    ...
    (PTB11_SIG_SEL>=0) || (PTB16_SIG_SEL>=0) || (PTB17_SIG_SEL>=0) || (PTB18_SIG_SEL>=0) || \
    (PTB19_SIG_SEL>=0) || (PTB20_SIG_SEL>=0) || (PTB21_SIG_SEL>=0) || (PTB22_SIG_SEL>=0) || \
    (PTB23_SIG_SEL>=0)
   ...
   SIM->FIXED_PORT_CLOCK_REG |= PORTB_CLOCK_MASK;
    ...
    (PTC12_SIG_SEL>=0) || (PTC13_SIG_SEL>=0) || (PTC16_SIG_SEL>=0) || (PTC17_SIG_SEL>=0) || \
    (PTC18_SIG_SEL>=0)
   ...
   SIM->FIXED_PORT_CLOCK_REG |= PORTD_CLOCK_MASK;
    ...
    (PTE5_SIG_SEL>=0) || (PTE6_SIG_SEL>=0) || (PTE16_SIG_SEL>=0) || (PTE17_SIG_SEL>=0) || \
    (PTE18_SIG_SEL>=0) || (PTE19_SIG_SEL>=0) || (PTE20_SIG_SEL>=0) || (PTE21_SIG_SEL>=0) || \
    (PTE22_SIG_SEL>=0) || (PTE23_SIG_SEL>=0) || (PTE24_SIG_SEL>=0) || (PTE25_SIG_SEL>=0) || \
    (PTE26_SIG_SEL>=0) || (PTE29_SIG_SEL>=0) || (PTE30_SIG_SEL>=0) || (PTE31_SIG_SEL>=0)
