/**
 * @file      gpio.cpp (derived from gpio-MK64F12-LQFP100.cpp)
 * @version   1.2.0
...
#endif
#if (PTA8_SIG_SEL>=0)
   { PORT_PCR_MUX(PTA8_SIG_SEL)|USBDM::DEFAULT_PCR, &PORTA->PCR[8]},
#endif
#if (PTA9_SIG_SEL>=0)
   { PORT_PCR_MUX(PTA9_SIG_SEL)|USBDM::DEFAULT_PCR, &PORTA->PCR[9]},
#endif
#if (PTA10_SIG_SEL>=0)
...
#endif
#if (PTA24_SIG_SEL>=0)
   { PORT_PCR_MUX(PTA24_SIG_SEL)|USBDM::DEFAULT_PCR, &PORTA->PCR[24]},
#endif
#if (PTA25_SIG_SEL>=0)
   { PORT_PCR_MUX(PTA25_SIG_SEL)|USBDM::DEFAULT_PCR, &PORTA->PCR[25]},
#endif
#if (PTA26_SIG_SEL>=0)
   { PORT_PCR_MUX(PTA26_SIG_SEL)|USBDM::DEFAULT_PCR, &PORTA->PCR[26]},
#endif
#if (PTA27_SIG_SEL>=0)
   { PORT_PCR_MUX(PTA27_SIG_SEL)|USBDM::DEFAULT_PCR, &PORTA->PCR[27]},
#endif
#if (PTA28_SIG_SEL>=0)
   { PORT_PCR_MUX(PTA28_SIG_SEL)|USBDM::DEFAULT_PCR, &PORTA->PCR[28]},
#endif
#if (PTA29_SIG_SEL>=0)
...
#endif
#if (PTE8_SIG_SEL>=0)
   { PORT_PCR_MUX(PTE8_SIG_SEL)|USBDM::DEFAULT_PCR, &PORTE->PCR[8]},
#endif
#if (PTE9_SIG_SEL>=0)
   { PORT_PCR_MUX(PTE9_SIG_SEL)|USBDM::DEFAULT_PCR, &PORTE->PCR[9]},
#endif
#if (PTE10_SIG_SEL>=0)
   { PORT_PCR_MUX(PTE10_SIG_SEL)|USBDM::DEFAULT_PCR, &PORTE->PCR[10]},
#endif
#if (PTE11_SIG_SEL>=0)
   { PORT_PCR_MUX(PTE11_SIG_SEL)|USBDM::DEFAULT_PCR, &PORTE->PCR[11]},
#endif
#if (PTE12_SIG_SEL>=0)
   { PORT_PCR_MUX(PTE12_SIG_SEL)|USBDM::DEFAULT_PCR, &PORTE->PCR[12]},
#endif
#if (PTE24_SIG_SEL>=0)
...
#endif
#if (PTE27_SIG_SEL>=0)
   { PORT_PCR_MUX(PTE27_SIG_SEL)|USBDM::DEFAULT_PCR, &PORTE->PCR[27]},
#endif
#if (PTE28_SIG_SEL>=0)
   { PORT_PCR_MUX(PTE28_SIG_SEL)|USBDM::DEFAULT_PCR, &PORTE->PCR[28]},
#endif
};
...
void usbdm_PinMapping() {
    ...
    (PTA8_SIG_SEL>=0) || (PTA9_SIG_SEL>=0) || (PTA10_SIG_SEL>=0) || (PTA11_SIG_SEL>=0) || \
    ...
    (PTA24_SIG_SEL>=0) || (PTA25_SIG_SEL>=0) || (PTA26_SIG_SEL>=0) || (PTA27_SIG_SEL>=0) || \
    (PTA28_SIG_SEL>=0) || (PTA29_SIG_SEL>=0)
   ...
   SIM->FIXED_PORT_CLOCK_REG |= PORTA_CLOCK_MASK;
    ...
    (PTB11_SIG_SEL>=0) || (PTB12_SIG_SEL>=0) || (PTB13_SIG_SEL>=0) || (PTB16_SIG_SEL>=0) || \
   ...
   SIM->FIXED_PORT_CLOCK_REG |= PORTC_CLOCK_MASK;
    ...
    (PTD11_SIG_SEL>=0) || (PTD12_SIG_SEL>=0) || (PTD13_SIG_SEL>=0) || (PTD14_SIG_SEL>=0) || \
    (PTD15_SIG_SEL>=0)
